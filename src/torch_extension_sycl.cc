...
TORCH_LIBRARY_FRAGMENT(sgl_kernel, m) {
  ...
  m.def(
      "flash_mla_decode(Tensor! out, Tensor! lse_out, Tensor! q_nope, Tensor! q_pe, Tensor! kv_c_and_k_pe_cache, Tensor! seq_lens, "
      "Tensor! "
  ...
  m.def(
      "flash_mla_prefill(Tensor! out, Tensor! lse_out, Tensor! q_nope, Tensor! q_pe, Tensor! kv_c_and_k_pe_cache, "
