...
using DecodeFn =
  void (*)(void*, void*, const void*, const void*, const void*, const void*, const void*, void*, double, int64_t);
...
bool mla_decode_launch(
  ...
  if (!fn) return false;
  fn(out, lse_out, q_nope, q_pe, kv_c_and_k_pe_cache, seq_lens, page_table, workspace, sm_scale, num_kv_splits);
  return true;
}
